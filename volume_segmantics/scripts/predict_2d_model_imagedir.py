...
from volume_segmantics.model import VolSeg2DImageDirPredictionManager
from volume_segmantics.utilities import get_2d_prediction_image_dir_parser
...
def main():
    ...
    # Parse Args
    parser = get_2d_prediction_image_dir_parser()
